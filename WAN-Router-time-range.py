...
for switch in switches:
    ...
    time_range_conf = send_ssh_command_get_response(remote_conn,"show run | s time-range\n",exec_prompt)
    parse = CiscoConfParse(time_range_conf.split("\r\n"))
    time_range_process = []
    time_range_process = parse.find_objects(r'time_range')
    if time_range_process:
        print time_range_process
    else:
        print "No Time Range"
    remote_conn_pre.close()
